...
of the same software installed (e.g. TransCAD 7 and TransCAD 8). By default,
...
into an interface/UI. The `caliperR` package comes with the utility function
`compile_gisdk()` to make this easy and a toy script to test it on. Code
compiled using Caliper software also works.
